...
public class StockAnalyzer {
    public static void main(String[] args) throws Exception {
        Method method = StockAnalyzer.class.getMethod("myTradingAlgorithm", double.class, int.class, double.class,
     ...
     * ============================================================================
     * 
     * The stock data file contains historical daily price data in the following
     * format:
     * 
     * DATE YYYY-MM-DD
     * OPEN XX.XX
     ...
     *         Day 2: CLOSE=120 -> peak=100, drawdown=(100-120)/100 = -0.20
     *         (negative, ignored)
     *         Day 3: CLOSE=110 -> peak=120, drawdown=(120-110)/120 = 0.083 (8.3%
     *         down from peak)
     *         Day 4: CLOSE=90 -> peak=120, drawdown=(120-90)/120 = 0.25 (25% down
     *         from peak)
     *         Day 5: CLOSE=95 -> peak=120, drawdown=(120-95)/120 = 0.208 (20.8%
     *         down from peak)
     ...
     * 
     * END OF SIMULATION:
     * - After processing all days, sell all remaining shares at the last CLOSE
     * price
     ...
     *         Return: $3.0
     * 
     *         Note: This is a simple strategy and will likely lose money on real
     *         data!
     ...
     * - Your average final balance across the 5 tests becomes your leaderboard
     * score
     ...
     *                    - StockTester.buyShare() - Buy 1 share at today's close
     *                    - StockTester.sellShare() - Sell 1 shares at today's close
     * 
     *                    RULES & CONSTRAINTS:
     ...
     * 
     *                    TIPS FOR SUCCESS:
     *                    - The simulated data has a slight upward drift (~0.1% per
     *                    day)
     *                    - Daily volatility is around 2%
     *                    - Use static variables to track state across days
     *                    (previous prices, etc.)
     *                    - Test your strategy logic carefully - small bugs can
     *                    cause big losses!
     *                    - Consider when NOT to trade (sometimes doing nothing is
     *                    the best move)
     * 
     *                    Good luck! May your algorithm prosper! 📈
     */
    public static void myTradingAlgorithm(double balance, int sharesOwned, double open, double high, double low,
            double close) {
